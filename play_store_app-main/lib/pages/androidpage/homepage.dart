import 'package:projectplaystore/library/source.dart';
import 'package:projectplaystore/pages/all_class/appsclass.dart';
        ...
        drawer: Container(
          ...
          child: Column(
            ...
            children:  [
              ...
              const CircleAvatar(
                radius: 40,
                backgroundImage:  NetworkImage("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTH5nQJWZQRIOVTwYPonRr-Rubtsan7gt7XgHvzwkmtEb86VTThf8sdNlc2N6kpul3t8A&usqp=CAU"),
              ),
              const SizedBox(height: 10,),
              const Text("Jenil Maiyani"),
...
class FirstTabScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    {
      return (index == 3)?Container():Container(
        ...
        child: Row(
          ...
          children: [
            Text(appsList[index].sname,style: const TextStyle(fontWeight: FontWeight.w700,fontSize: 18),),
      ...
      separatorBuilder: (context, index){
        return SingleChildScrollView(
          ...
          child: Row(
            children: appsList[index].listname.map((e) => Padding(
              padding: const EdgeInsets.only(left: 10),
              child: InkWell(
                borderRadius: BorderRadius.circular(15),
                onTap: (){
                  Navigator.of(context).pushNamed("install_page",arguments: e);
                },
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4,),
                    Text("${e.rating}⭐",style: const TextStyle(fontSize: 10),),
                    const SizedBox(height: 4,),
                  ],
                ),
              ),
        ...
        children: [
          Padding(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text("Show installed apps",style: TextStyle(color: Colors.grey),),
                Switch(
                    activeColor: indicatorColor,
                    value: installSwitchVal, onChanged: (val){
          ...
          Padding(
            ...
            child: Column(
              children: recommended.map((e) =>  Row(
                children: [
                  Text(("${recommended.indexOf(e) + 1}"),style: const TextStyle(color: Colors.grey),),
                  Container(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(e.subName,style: const TextStyle(color: Colors.grey),),
                      const SizedBox(height: 15,),
                      Row(
                        children:
                        [
